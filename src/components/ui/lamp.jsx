...
import { CoverDemo } from "../specific/callpreloader";
...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-[100vw] rounded-md z-60",
        className
      )}>
      <div
      ...
      <div className="relative z-50 flex -translate-y-80 flex-row items-center px-5 w-[60%]">
        {children}
      </div>
    </div>)
  );
